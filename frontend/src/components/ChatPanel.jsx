    ...
    <div className="flex flex-col h-full min-h-[600px] bg-gray-900/50 backdrop-blur-sm border border-gray-800 rounded-lg">
      ...
      <div className="flex items-center justify-between p-4 border-b border-gray-800">
        ...
        <div className="flex items-center gap-2 px-3 py-1 bg-blue-500/10 border border-blue-500/30 rounded-full">
          ...
          <span className="text-xs font-semibold text-blue-400">Powered by Groq</span>
        </div>
      </div>
      ...
      <div className="flex-1 overflow-y-auto p-4 space-y-4">
        {messages.length === 0 && !loading && (
          <div className="flex flex-col items-center justify-center h-full text-center">
            ...
            <h3 className="text-xl font-semibold text-white mb-2">Ask AI anything about this codebase</h3>
            <p className="text-gray-400 mb-6 max-w-md">
              Our AI has analyzed the entire repository and can answer questions about architecture,
